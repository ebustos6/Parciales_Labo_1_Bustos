...
*
*/
int electro_alta(eElectro array[], int size, int *contadorID, eMarca arrayMarca[], int sizeMarca, eProcedencia arrayProcedencia[], int sizeProcedencia);
...
*
*/
int procedencia_listado(eProcedencia array[], int size);
